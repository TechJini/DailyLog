package com.example.techjini.stepcounter.fragment;
...
import com.example.techjini.stepcounter.receiver.PowerReceiver;
        ...
        findPreference("notification")
                .setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
                    ...
                    public boolean onPreferenceChange(final Preference preference,
                        ...
                        getActivity().startService(new Intent(getActivity(), SensorListenerService.class)
                                .putExtra(SensorListenerService.ACTION_UPDATE_NOTIFICATION, true));
                        return true;
                    }
                });
